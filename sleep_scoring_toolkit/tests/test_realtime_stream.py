...
from sleep_scoring_toolkit.realtime_with_restart.main_multiprocess import main
...
class TestRealtimeStream(unittest.TestCase):
    ...
    @patch('sleep_scoring_toolkit.realtime_with_restart.main_multiprocess.os.path.isfile')
    @patch('sleep_scoring_toolkit.realtime_with_restart.main_multiprocess.create_trimmed_csv')
    @patch('sleep_scoring_toolkit.realtime_with_restart.main_multiprocess.BoardManager')
    @patch('sleep_scoring_toolkit.realtime_with_restart.main_multiprocess.BrainFlowChildProcessManager')
    @patch('sleep_scoring_toolkit.realtime_with_restart.main_multiprocess.logger')
