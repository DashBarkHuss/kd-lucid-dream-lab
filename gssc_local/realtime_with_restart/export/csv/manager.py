...
class CSVManager:
    ...
    def _validate_sleep_stage_data(self, sleep_stage: float, next_buffer_id: float, epoch_end_idx: int) -> None:
        ...
        if epoch_end_idx >= len(self.main_csv_buffer):
            ...
            epoch_end_idx = len(self.main_csv_buffer) - 1 # TODO: figure out if this is necessary: what does this do? does it change the original variable passed in?
    ...
    def _validate_file_contents(self, file_path: str) -> Dict:
    ...
    def _validate_buffer_data(self, data: List[List[float]]) -> None:
